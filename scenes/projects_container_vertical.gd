class_name ProjectSelectorVertical
extends Control
...
@onready var smooth_scroll_container: SmoothScrollContainer = $ProjectsContainer/MainPanel/MainMargin/MainContainer/CardsScroll
@onready var cards_container: VBoxContainer = $ProjectsContainer/MainPanel/MainMargin/MainContainer/CardsScroll/CardsMargin/CardsContainer
...
@onready var cancel_button: Button = $ProjectsContainer/MainPanel/MainMargin/MainContainer/MarginContainer/ButtonsContainer/CancelButton
@onready var save_button: Button = $ProjectsContainer/MainPanel/MainMargin/MainContainer/MarginContainer/ButtonsContainer/SaveButton
@onready var buttons_margin: MarginContainer = $ProjectsContainer/MainPanel/MainMargin/MainContainer/MarginContainer
...
func _ready() -> void:
	...
	buttons_margin.visible = use_save
...
func focus_title() -> void:
	var card_container: CardContainer = cards_container.get_child(0)
	card_container.card.edit_title_line_edit.grab_focus()
...
func add_project(title: String, description: String, image: Texture2D, project_uuid: String, grab_focus_field: int = -1) -> void:
	...
	card_container.use_vertical = true
	...
	if use_save:
		new_card.edit_title_line_edit.focus_next = save_button.get_path()
		new_card.edit_title_line_edit.focus_previous = cancel_button.get_path()
		cancel_button.focus_next = new_card.edit_title_line_edit.get_path()
		save_button.focus_previous = new_card.edit_title_line_edit.get_path()
...
func play_intro() -> void:
	...
	opening_tween.tween_property(main_panel, ^"size_flags_stretch_ratio", 2, section_in_time)
